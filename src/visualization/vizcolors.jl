...
"""
nodeColor(colors::VizColors, node::Node) = CSFML.Color(0,0,0)

"""
    `roadColor` returns a road's color
"""
roadColor(colors::VizColors, road::Road) = CSFML.Color(50,50,255)
...
mutable struct RoadTypeColors <: VizColors
    typecolors::Vector{CSFML.Color}
end

RoadTypeColors() = RoadTypeColors(
        [CSFML.Color(0,255,0)  , CSFML.Color(55,200,0), CSFML.Color(105,150,0),
         CSFML.Color(150,105,0), CSFML.Color(0,0,125) , CSFML.Color(0,0,125)  ,
         CSFML.Color(0,0,125)  , CSFML.Color(0,0,125)])
...
nodeColor(colors::FadedColors, node::Node) = CSFML.Color(0,0,0, colors.transp)

function FadedColors(transp)
    a = round(Int, transp*255)
    FadedColors(
        [CSFML.Color(0,255,0, a)  , CSFML.Color(55,200,0, a), CSFML.Color(105,150,0, a),
         CSFML.Color(150,105, a), CSFML.Color(0,0,125, a) , CSFML.Color(0,0,125, a)  ,
         CSFML.Color(0,0,125, a)  , CSFML.Color(0,0,125, a)], a)
end
...
function roadColor(colors::SpeedColors, road::Road)
    ...
    return CSFML.Color(round(Int,color.r*255),round(Int,255*color.g),round(Int,255*color.b))
end
